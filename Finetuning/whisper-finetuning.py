...
output_dir = f'{HF_username}/{model_name[6:]}FT-{dataset_name[5:]}-{language or "noLID"}' # if there's a slash in your dataset_name make sure to slice e.g. for dataset_name 'sqrk/dataset', use dataset_name[5:] in your output file name
